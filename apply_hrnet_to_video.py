...
video_or_camera = "/media/filip/HDD1/id00027.mp4"
dataset = "MPII"
...
out = cv2.VideoWriter(video_or_camera +"_output.mp4",-1, 30.0, (1920,1080))
...
while (ret):
    ...
    out.write(cv2.cvtColor(np.asarray(result(input_copy, output)), cv2.COLOR_RGB2BGR))
